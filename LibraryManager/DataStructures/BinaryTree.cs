...
namespace LibraryManager.DataStructures
{
    class BinaryTree<T>
    {
        ...
        public BinaryTree(WithKey rootValue)
        {
        ...
        private WithKey inOrderSuccessor(TreeNode root)
        {
            WithKey minimum = root.Data;
        ...
        private TreeNode insert(TreeNode root, WithKey data)
        {
            // tree is empty
            if (root == null)
        ...
        public WithKey Find(string key)
        {
    ...
    {
        public WithKey Data { get; set; }
        public TreeNode LeftChild { get; set; }
        public TreeNode RightChild { get; set; }

        public TreeNode(WithKey data, TreeNode leftChild = null, TreeNode rightChild = null)
        {
            this.Data = data;
